...
Full design — and the numbers, which live in config rather than in prose: [glossary](docs/project/glossary.md) · [reputation](docs/project/reputation.md) · [identity](docs/project/identity.md) · [chain](docs/project/chain.md) · [architecture](docs/project/architecture.md)
